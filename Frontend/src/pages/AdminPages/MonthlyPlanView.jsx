...
// used across the daily/monthly plan pages. (Not to be confused
// with the app's persistent left-nav Sidebar component below —
// this one is the small in-page context card.)
// ============================================================
...
// ============================================================
// Back button — same square bordered icon button used on
// HallDashboard / other desktop pages.
// ============================================================
...
export default function AdminMonthlyPlanView() {
  const { id } = useParams();
    ...
    return (
      <div className="flex h-screen overflow-hidden bg-[#EFEFEF]">
        ...
        <div className="flex min-h-0 flex-1 flex-col items-center justify-center gap-3">
          ...
          <button
            onClick={handleBack}
            className="flex items-center gap-1.5 border border-[#C6C6C6] bg-white px-3 py-1.5 text-[11px] font-semibold text-[#0F1D24] transition-colors duration-100 hover:border-[#0F1D24] hover:bg-[#0F1D24] hover:text-[#FDC94D]"
          >
            <HiOutlineArrowLeft className="h-3.5 w-3.5" />
            Go Back
          </button>
