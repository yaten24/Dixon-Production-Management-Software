...
const AdminDailyPlanPage = () => {
  ...
  const handleOpen = (plan) => navigate(`/admin/production/plans/detail/${plan.daily_plan_id}`);
  const handleCreate = () => navigate("/admin/production/plans/daily/create");
...
export default AdminDailyPlanPage;