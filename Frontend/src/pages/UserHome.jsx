...
// ============================================================
// PAGE — fixed to viewport height, no page-level scrollbar.
// Each row below the header gets a flex-basis share of the
// remaining height; only individual panels (Today's Summary,
// Recent Activity, Alerts) scroll internally if their content
// overflows their own fixed slot.
// ============================================================
const UserHome = () => {
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-[#EFEFEF]">
      ...
      <main
        ...
        style={{ paddingTop: HEADER_HEIGHT + 6 }}
      >
