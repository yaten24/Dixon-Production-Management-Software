...
const monthlyDashboardRoutes = require("./routes/monthlyDashBoardRoutes")
const datewiseProductionDashboard = require("./routes/dateWiseProductionRoutes")
...
app.use("/api/monthly/dashboard", monthlyDashboardRoutes);
